...
`html_attr()`      | get specific attribute value (nset)
`html_attrs()`     | get all attributes (nset)
`html_children()`  | get children of node (doc, nset)



doc: parsed document; nset: node set or node; file: un-parsed XML document


 `xml_contents`   `xml_find_all`   `xml_find_one`  
